 ...
 * @endcode
 */
$settings['hash_salt'] = 'lSoj2T5RpuT3u3zh4_cvI9dexno3jsJ3jXuOIwQdU495-sphtgMhNMqyu_EROWrwwhL47LP3ag';
...
$settings['file_public_path'] = 'sites/nanaimopaddlers.org/files';
...
$settings['file_private_path'] = '/var/www/html/private/nanaimopaddlers';
...
// Override the DDEV database configuration with paddleclub.ca-specific settings
$databases['default']['default'] = [
  'database' => 'db_nanaimopaddlers',
  'username' => 'db',
  'password' => 'db',
  'host' => 'db',
  'port' => '3306',
...
$settings['config_sync_directory'] = 'sites/nanaimopaddlers.org/files/config_a_aT4ty-T_tL1C3vUb13Ulpz_EYzUNe9ytNi_sGSzg8Y8ObFSDmbGkHprBmkTOZstZKklcFjUQ/sync';
