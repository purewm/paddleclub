 ...
 * @endcode
 */
$settings['hash_salt'] = 'ZCHUz0ZHoAxYtJZBcXRziu9cw-7WcMLJcLGJeX2Y5ssf-caNj90745sQkD-o36z0DfukRMJHZA';
...
$settings['file_public_path'] = 'sites/siska.ca/files';
...
$settings['file_private_path'] = '/var/www/html/private/siska';
...
// Override the DDEV database configuration with a paddleclub-specific settings
$databases['default']['default'] = [
  'database' => 'db_siska',
  'username' => 'db',
  'password' => 'db',
...
$settings['config_sync_directory'] = 'sites/siska.ca/files/config_w60nSEDeGYVyuBrgvoiONHsEKGbAuVka-4utHR5GHPiFU4w1ep1rk2p7r191wYBCT8Gw3IIYNg/sync';
