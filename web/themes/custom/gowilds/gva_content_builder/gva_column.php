...
class element_gva_column{
			...
			'fields'	=> array(
				...
				array(
				  	...
				  	'options'    => array(
					 	...
					 	'bg-inner-radius' => 'Background Content Inner & Radius',
					 	'bg-inner-effect' => 'Background Content Inner & Effect',
					 	'bg-inner-radius-large' => 'Background Content Inner & Radius Large',
					)
				),
				array(
				  'id'        => 'info',
			 ...
			 array(
				'id'         => 'horizontal_align',
				'type'       => 'select',
				'title'      => t('Content Horizontal Align'),
				'class'      => 'width-1-3',
				'options'    => array(
				  ''                 => 'Default',
				  'align-flex-left'         => 'Horizontal Align Left',
				  'align-flex-center-h'     => 'Horizontal Align Middle',
				  'align-flex-right'        => 'Horizontal Align Right',
				)
			 ),
			 array(
				'id'         => 'style_class',
	...
	public function render_content( $settings = array(), $content = '' ) {
		...
		extract(gavias_merge_atts(array(
			...
			if ($bg_layout == 'bg-inner-radius'){
				$array_style[] 	= 'border-radius: 10px;';
			}
			if ($bg_layout == 'bg-inner-effect'){
				$array_style[] 	= 'animation: beat1 10s ease 10s infinite;';
			}
			if ($bg_layout == 'bg-inner-radius-large'){
				$array_style[] 	= 'border-radius: 300px 300px 0px 0px;';
			}
			...
			if($bg_layout == 'bg-inner' || $bg_layout == 'bg-inner-radius' || $bg_layout == 'bg-inner-effect' || $bg_layout == 'bg-inner-radius-large'){
