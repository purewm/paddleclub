...
if(!class_exists('element_gva_icon_box_classic')):
   class element_gva_icon_box_classic{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         ob_start();
         ?>
         <?php if($icon_position=='top-center' || $icon_position=='top-left' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left' || $icon_position=='left-2' || $icon_position=='left-3' || $icon_position=='left-4'){ ?>
